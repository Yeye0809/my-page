...
const carrowsel = ['GifApp','gifmarvel']

export const GifExpertProject = () => {
  ...
  return (
    <Grid container justifyContent='center' >
        <Grid item component='div' sx={{position: 'relative', maxHeight: 185, maxWidth: 255}}>
            ...
            <img src={`./assets/GifExpertApp/${carrowsel[count]}.PNG`} alt={`${carrowsel[count]}`}  className='img-projects'/>
